...
# fmt: off
SUITE_SATISFICING = [f"sat-{x}" for x in [
    'agricola', 'airport', 'airport-adl', 'assembly', 'barman', 'blocksworld',
    'briefcaseworld', 'caldera-adl', 'caldera-split-adl', 'cavediving',
    'cavediving-adl', 'childsnack', 'citycar', 'citycar-adl', 'data-network',
    'depots', 'driverlog', 'elevators', 'ferry', 'flashfill-adl', 'floortile',
    'freecell', 'fsc-blocks', 'fsc-grid-a', 'fsc-grid-r', 'fsc-hall',
    'fsc-visualmarker', 'ged', 'gedp-ds2ndp', 'goldminer', 'grid', 'gripper',
    'hanoi', 'hiking', 'logistics', 'maintenance', 'maintenance-adl',
    'maintenance_large', 'miconic', 'miconic-fulladl', 'miconic-simpleadl',
    'movie', 'mprime', 'mystery', 'no-mprime', 'no-mystery', 'nomystery',
    'npuzzle', 'nurikabe-adl', 'openstacks', 'openstacks-adl',
    'optical-telegraphs', 'organic-synthesis', 'organic-synthesis-split',
    'parcprinter', 'parking', 'pathways', 'pathways-noneg', 'pegsol',
    'petri-net-alignment', 'philosophers', 'pipesworld-notankage',
    'pipesworld-tankage', 'psr-large', 'psr-middle', 'psr-small', 'rovers',
    'satellite', 'scanalyzer', 'schedule', 'settlers-adl', 'snake', 'sokoban',
    'spanner', 'spider', 'storage', 't0-adder', 't0-coins', 't0-comm',
    't0-grid-dispose', 't0-grid-push', 't0-grid-trash', 't0-sortnet',
    't0-sortnet-alt', 't0-uts', 'termes', 'tetris', 'thoughtful', 'tidybot',
    'tpp', 'transport', 'trucks', 'visitall', 'woodworking', 'zenotravel']]



SUITE_OPTIMAL_STRIPS = [f"opt-{x}" for x in [
    'agricola', 'airport', 'airport-adl', 'assembly', 'barman', 'blocksworld',
    'briefcaseworld', 'caldera-adl', 'caldera-split-adl', 'cavediving',
    'cavediving-adl', 'childsnack', 'citycar', 'citycar-adl', 'data-network',
    'depots', 'driverlog', 'elevators', 'ferry', 'flashfill-adl', 'floortile',
    ...
    'parcprinter', 'parking', 'pathways', 'pathways-noneg', 'pegsol',
    'petri-net-alignment', 'philosophers', 'pipesworld-notankage',
    'pipesworld-tankage', 'psr-large', 'psr-middle', 'psr-small',
    'rovers', 'satellite', 'scanalyzer', 'schedule', 'settlers-adl',
    'snake', 'sokoban', 'spanner', 'spider', 'storage', 't0-adder',
    't0-coins', 't0-comm', 't0-grid-dispose', 't0-grid-push', 't0-grid-trash',
    't0-sortnet', 't0-sortnet-alt', 't0-uts', 'termes', 'tetris', 'thoughtful',
